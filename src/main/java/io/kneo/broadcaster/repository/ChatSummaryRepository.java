...
import io.kneo.broadcaster.model.chat.ChatSummary;
...
import static io.kneo.broadcaster.repository.table.KneoBroadcasterNameResolver.CHAT_SUMMARY;
...
public class ChatSummaryRepository extends AsyncRepository {
    ...
    private static final EntityData entityData = KneoBroadcasterNameResolver.create().getEntityNames(CHAT_SUMMARY);
