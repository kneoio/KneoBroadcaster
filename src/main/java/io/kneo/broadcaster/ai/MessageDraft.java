...
public class MessageDraft implements IDraft {
    ...
    public MessageDraft(String title, String artist, String aiDjName, String brand,
    ...
    private static Map<String, Map<String, String>> loadTranslations() {
        try {
            ...
            InputStream inputStream = MessageDraft.class.getClassLoader().getResourceAsStream("draftbuilder_messages.json");
